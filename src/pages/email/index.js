...
// ** Demo Tabs Imports
import SingleSMSSend from 'src/views/pages/email/SingleSMSSend'
import BulkSMSSend from 'src/views/pages/email/BulkSMSSend'
import SmsTransaction from 'src/views/pages/email/SmsTransaction'
      ...
      <TabContext value={value}>
        ...
        >
          ...
          <Tab
            ...
            label={
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <MessageBadge sx={{ fontSize: '1.125rem' }} />
                <TabName>Bulk Email</TabName>
              </Box>
            }
          />
          <Tab
